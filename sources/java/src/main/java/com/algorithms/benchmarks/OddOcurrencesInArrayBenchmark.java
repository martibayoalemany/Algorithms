...
import com.algorithms.codility.OddOccurrencesInArray;
...
public class OddOcurrencesInArrayBenchmark {
    ...
    public void solution1(Datas data) {
        OddOccurrencesInArray.solution(data.target);
    }

    @Benchmark
    public void solution3(Datas data) {
        OddOccurrencesInArray.solution3(data.target);
    }
}
