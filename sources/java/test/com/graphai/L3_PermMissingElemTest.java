...
import src.main.com.algorithms.codility.L3_PermMissingElem;
...
public class L3_PermMissingElemTest {
    protected final Integer[] data;
    protected final Integer expected;

    public L3_PermMissingElemTest(Integer[] data, Integer expected) {
        this.data = data;
    ...
    public void solution() throws Exception {
        Integer actual = L3_PermMissingElem.solution(data);
